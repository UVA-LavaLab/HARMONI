...
#SBATCH --output=log_slurm/mid_%A_%a.out
#SBATCH --error=log_slurm/mid_%A_%a.err
#SBATCH --mem=32GB
#SBATCH --cpus-per-task=4
#SBATCH --mail-type=begin,end
#SBATCH --mail-user=vyn9mp@virginia.edu
#SBATCH --array=0-20 # Adjust the range based on the number of lines in params/*.txt
